package nguyenxuanhai_springbootjwt.nguyenxuanhai_springbootjwt.ulti;
...
public class JwtUtil {
    ...
    private static final String USER = "hai";
    private static final String SECRET = "hey Hai the secrect length must be at least 256 bits" +
            " please no reveal!";
